...
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("pkill hyprpaper && hyprpaper"))

hl.bind(
	"Print",
	hl.dsp.exec_cmd('grim -g "$(slurp)" /home/anton/Pictures/screenshots/screenshot_$(date +%Y%m%d%H%M%S).png')
)
hl.bind(
	"ALT + Print",
	hl.dsp.exec_cmd(
		'grim -g "$(hyprctl activewindow -j | jq -r \'"(.at[0]),(.at[1]) (.size[0]x(.size[1])"\')" /home/anton/Pictures/screenshots/screenshot_$(date +%Y%m%d%H%M%S).png'
	)
)
